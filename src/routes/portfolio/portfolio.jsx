  ...
  return (
    <div className="portfolio-container">
      <div className="portfolio-header">
        ...
        <p className="intro">
          I'm passionate about designing and coding web apps, and my portfolio
          reflects my dedication to these interests.
        </p>
        <div className="social-links">
          <Link to="mailto:puneetkathuria2525@gmail.com">
            <span>→</span> Email{" "}
          </Link>
          <Link to="https://www.linkedin.com/in/puneet-kathuria-33a296220/">
            <span>→</span> LinkedIn{" "}
          </Link>
          <Link to="https://www.instagram.com/puneet.25_">
            <span>→</span> Instagram{" "}
          </Link>
        </div>
      </div>
      ...
      <div className="portfolio-projects">
        <div className="projects-display">
          <div className="projects-section">
            ...
            <Link
              to="https://www.behance.net/gallery/172507501/Road-Assistance-App-UI-Design"
            ...
            <Link
              to="https://www.youtube.com/live/Ouuff7UdBNI?si=k3kO3y0-kxX6qGGX&t=1789"
              className="project-wrap"
            >
              <div className="project-tag">
            ...
            <Link
              to="https://github.com/puneetk0/keeperApp"
              className="project-wrap"
            >
              <div className="project-tag">
            ...
            <Link
              to="https://github.com/puneetk0/toDoList"
              className="project-wrap"
            >
              <div className="project-tag">
                <p>UI Design</p> <p>Freelance</p>
              ...
              <div className="project-title">
                ...
                <p>A simple To-Do web app but with some *aesthetics*</p>
              </div>
              <div className="project-image">
                <img src={todo} />
              </div>
